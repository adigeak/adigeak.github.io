...
```yml
# Site settings
title: AD Blog             # title of your website
SEOTitle: AD Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: ADpro     # modify this account to yours
weibo_username: ADpro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-AD.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“AD Blog”** but I want the title shows in search engine is **“黄玄的博客 | AD Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/ADpro/ADpro.github.io/issues/15) about code wrap.
